...
export default function Register() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 flex flex-col items-center py-12 animate-fade-up">
      ...
      <h1 className="font-display text-3xl text-matcha-950 mb-2 font-bold">Crear cuenta</h1>
      <p className="text-matcha-600 mb-8">Empieza a juntar tus matchas</p>
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-matcha-700 mb-1.5">Nombre de usuario</label>
          <input
            type="text"
            name="username"
            value={form.username}
