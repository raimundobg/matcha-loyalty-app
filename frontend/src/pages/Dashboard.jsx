      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-sm border border-matcha-100">
        ...
        <div className="space-y-4">
          {preview ? (
            ...
            <label className="flex flex-col items-center justify-center h-40 border-2 border-dashed border-matcha-200 rounded-2xl cursor-pointer hover:border-matcha-400 hover:bg-matcha-50/50 transition-all">
